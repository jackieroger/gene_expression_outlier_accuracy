...
gathered_results_raw <- read_tsv("2020_12_03/outlier_probability_output_CKCC_2020_12_03.tsv.gz") 

gathered_results <- gathered_results_raw %>%
  select(Sample, Gene, Type, Expression, Threshold, Mean_Accuracy = `Probability of being an outlier`)
